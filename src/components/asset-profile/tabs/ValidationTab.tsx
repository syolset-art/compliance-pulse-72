...
const AREA_DEFS = [
  ...
  { key: "operations", labelEn: "Operations & Security", labelNb: "Drift og sikkerhet", descEn: "Risk assessment and operational processes", descNb: "Risikovurdering og driftsprosesser" },
  ...
  { key: "vendor", labelEn: "Third-Party & Value Chain", labelNb: "Tredjepartstyring og verdikjede", descEn: "Third-party oversight and supply chain controls", descNb: "Tredjeparts tilsyn og leverandørkontroll" },
] as const;
