...
const QUARTERS: { key: string; label_no: string; label_en: string; phase_no: string; phase_en: string; activities: QuarterActivity[] }[] = [
  ...
  },
  {
    ...
    activities: [
      ...
      { label_no: "Opplæring og bevisstgjøring", label_en: "Training and awareness", route: "/mynder-me", frequency: "ongoing", isoRef: "ISO 27001 7.2–7.3" },
      { label_no: "Overvåking og avvik", label_en: "Monitoring and deviations", route: "/deviations", frequency: "ongoing", isoRef: "ISO 27001 10.1" },
    ],
  },
  {
    key: "q4",
