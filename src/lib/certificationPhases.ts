...
export const CERTIFICATION_PHASES: PhaseDefinition[] = [
  {
    ...
    name_no: 'Fundament',
    name_en: 'Foundation',
    description_no: 'Etabler kontekst, omfang og synlighet',
    description_en: 'Establish context, scope and visibility',
  ...
  },
  {
    ...
    description_no: 'Utform retningslinjer, kontroller og risikostyring',
    description_en: 'Design policies, controls and risk management',
  ...
  },
  {
    ...
    name_no: 'Drift',
    name_en: 'Operation',
    description_no: 'Drift kontroller og håndter samsvar i daglig arbeid',
    description_en: 'Operate controls and manage compliance in daily work',
  ...
  },
  {
    ...
    description_no: 'Evaluer og forbedre styringssystemet',
    description_en: 'Evaluate and improve the management system',
    ...
    optional: false,
    whatToExpect_no: 'I denne fasen evaluerer dere om styringssystemet fungerer som tiltenkt, gjennomfører internrevisjon og ledelsesgjennomgang, og iverksetter korrigerende tiltak.',
    whatToExpect_en: 'In this phase you evaluate whether the management system works as intended, conduct internal audits and management reviews, and implement corrective actions.',
  ...
  },
  {
    ...
    description_no: 'Ekstern revisjon og sertifisering',
    description_en: 'External audit and certification',
