...
// ============================================
// NIS2 - Selected articles (demo)
// ============================================

export const NIS2_REQUIREMENTS: ComplianceRequirement[] = [
  { framework_id: 'nis2', requirement_id: 'NIS2-21.1', category: 'governance', name: 'Risk management measures', name_no: 'Tiltak for risikostyring', description: 'Take appropriate technical, operational and organisational measures to manage risks to network and information systems.', description_no: 'Iverksette egnede tekniske, operasjonelle og organisatoriske tiltak for å håndtere risiko mot nettverks- og informasjonssystemer.', priority: 'critical', domain: 'security', sla_category: 'governance', agent_capability: 'assisted', sort_order: 1 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2a', category: 'governance', name: 'Policies on risk analysis and information system security', name_no: 'Retningslinjer for risikoanalyse og informasjonssikkerhet', description: 'Establish policies on risk analysis and information system security.', description_no: 'Etablere retningslinjer for risikoanalyse og informasjonssystem-sikkerhet.', priority: 'critical', domain: 'security', sla_category: 'governance', agent_capability: 'full', sort_order: 2 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2b', category: 'organizational', name: 'Incident handling', name_no: 'Hendelseshåndtering', description: 'Establish processes for detection, response and recovery from incidents.', description_no: 'Etablere prosesser for deteksjon, respons og gjenoppretting etter hendelser.', priority: 'critical', domain: 'security', sla_category: 'operations', agent_capability: 'assisted', sort_order: 3 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2c', category: 'organizational', name: 'Business continuity and crisis management', name_no: 'Driftskontinuitet og krisehåndtering', description: 'Maintain business continuity through backup management, disaster recovery and crisis management.', description_no: 'Opprettholde driftskontinuitet gjennom sikkerhetskopiering, katastrofegjenoppretting og krisehåndtering.', priority: 'high', domain: 'security', sla_category: 'operations', agent_capability: 'assisted', sort_order: 4 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2d', category: 'organizational', name: 'Supply chain security', name_no: 'Forsyningskjedesikkerhet', description: 'Address security of the supply chain, including relationships with direct suppliers and service providers.', description_no: 'Ivareta sikkerhet i forsyningskjeden, inkludert forhold til direkte leverandører og tjenesteleverandører.', priority: 'high', domain: 'security', sla_category: 'vendor', agent_capability: 'assisted', sort_order: 5 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2e', category: 'technological', name: 'Security in acquisition, development and maintenance', name_no: 'Sikkerhet ved anskaffelse, utvikling og vedlikehold', description: 'Security in network and information systems acquisition, development and maintenance, including vulnerability handling and disclosure.', description_no: 'Sikkerhet ved anskaffelse, utvikling og vedlikehold av nettverks- og informasjonssystemer, inkludert sårbarhetshåndtering.', priority: 'medium', domain: 'security', sla_category: 'operations', agent_capability: 'assisted', sort_order: 6 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2f', category: 'governance', name: 'Effectiveness assessment of cybersecurity measures', name_no: 'Vurdering av effektivitet av sikkerhetstiltak', description: 'Policies and procedures to assess the effectiveness of cybersecurity risk-management measures.', description_no: 'Retningslinjer og prosedyrer for å vurdere effektiviteten av risikostyringstiltak.', priority: 'medium', domain: 'security', sla_category: 'governance', agent_capability: 'assisted', sort_order: 7 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2g', category: 'people', name: 'Cyber hygiene and training', name_no: 'Cyberhygiene og opplæring', description: 'Basic cyber hygiene practices and cybersecurity training for staff.', description_no: 'Grunnleggende cyberhygiene-praksis og opplæring for ansatte.', priority: 'high', domain: 'security', sla_category: 'people', agent_capability: 'full', sort_order: 8 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2h', category: 'technological', name: 'Cryptography and encryption', name_no: 'Kryptografi og kryptering', description: 'Policies and procedures regarding the use of cryptography and, where appropriate, encryption.', description_no: 'Retningslinjer for bruk av kryptografi og, der det er hensiktsmessig, kryptering.', priority: 'high', domain: 'security', sla_category: 'operations', agent_capability: 'assisted', sort_order: 9 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2i', category: 'technological', name: 'Access control and asset management', name_no: 'Tilgangsstyring og ressursforvaltning', description: 'Human resources security, access control policies and asset management.', description_no: 'Personellsikkerhet, retningslinjer for tilgangsstyring og ressursforvaltning.', priority: 'high', domain: 'security', sla_category: 'operations', agent_capability: 'assisted', sort_order: 10 },
  { framework_id: 'nis2', requirement_id: 'NIS2-21.2j', category: 'technological', name: 'Multi-factor authentication and secure communications', name_no: 'Flerfaktorautentisering og sikker kommunikasjon', description: 'Use of multi-factor or continuous authentication, secured voice/video/text communications and secured emergency communications.', description_no: 'Bruk av flerfaktor- eller kontinuerlig autentisering, sikret kommunikasjon og sikret nødkommunikasjon.', priority: 'medium', domain: 'security', sla_category: 'operations', agent_capability: 'assisted', sort_order: 11 },
  { framework_id: 'nis2', requirement_id: 'NIS2-23', category: 'legal', name: 'Incident reporting to CSIRT', name_no: 'Hendelsesrapportering til CSIRT', description: 'Notify CSIRT or competent authority of significant incidents without undue delay (early warning within 24h, full notification within 72h).', description_no: 'Varsle CSIRT eller kompetent myndighet om betydelige hendelser uten unødig opphold (tidlig varsel innen 24t, full melding innen 72t).', priority: 'critical', domain: 'security', sla_category: 'operations', agent_capability: 'assisted', sort_order: 12 },
];
