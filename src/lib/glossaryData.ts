...
export const GLOSSARY_TERMS: GlossaryTerm[] = [
  ...
  { term: 'Compliance-sjekkliste', definition_no: 'Automatisk generert liste over krav fra aktive rammeverk (GDPR, ISO 27001, NIS2). Viser fremdrift og mangler.', definition_en: 'Automatically generated list of requirements from active frameworks (GDPR, ISO 27001, NIS2). Shows progress and gaps.', category: 'mynder', route: '/compliance-checklist' },
