...
export const SARA_MONITORED_SYSTEMS: SaraMonitoredSystem[] = [
  ...
  { id: "entra", name: "Microsoft Entra ID", watches: "Ikke tilkoblet", status: "out_of_scope" },
  { id: "m365", name: "Microsoft 365", watches: "Ikke tilkoblet", status: "out_of_scope" },
  { id: "fileshare", name: "Filområde (on-prem)", watches: "Ikke tilkoblet", status: "out_of_scope" },
