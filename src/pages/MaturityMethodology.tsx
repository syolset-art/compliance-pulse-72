        ...
        <div className="max-w-2xl mx-auto px-6 py-10 space-y-10">
            ...
            <div className="grid gap-3">
              {[
                ...
                },
                {
                  ...
                  iconColor: "text-status-closed dark:text-status-closed",
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-xl border border-border/50 bg-warning/5 border-l-[3px] border-l-amber-500 p-4 flex items-start gap-4">
              ...
              <div className="rounded-xl border border-border/50 bg-status-closed/5 border-l-[3px] border-l-emerald-500 p-4 flex items-start gap-4">
                <div className="h-10 w-10 rounded-xl bg-status-closed/10 flex items-center justify-center flex-shrink-0">
                  <Shield className="h-5 w-5 text-status-closed dark:text-status-closed" />
                </div>
                <div>
              ...
              <div className="rounded-xl border border-primary/20 bg-primary/5 border-l-[3px] border-l-primary p-4 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-0.5">
                    {t(
                      "Gjennomsnittet av alle kontroll-nivåer gir din modenhetsscore. Scoren vises fordelt på fire fokusområder: Styring, Drift og sikkerhet, Personvern og datahåndtering og Tredjepart og verdikjede.",
                      "The average of all control levels gives your maturity score. The score is shown across four focus areas: Governance, Drift og sikkerhet, Privacy & Data Handling and Third-Party & Supply Chain."
                    )}
                  </p>
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="relative h-2 rounded-full bg-muted/40 overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-r from-status-closed via-warning via-warning to-primary rounded-full" />
              </div>
                ...
                {[
                  {
                    ...
                    color: "bg-status-closed", borderColor: "border-t-emerald-500", bgColor: "bg-status-closed/5",
                    icon: Bot, iconColor: "text-status-closed dark:text-status-closed",
                  ...
                  },
                  {
                    ...
                    color: "bg-warning", borderColor: "border-t-amber-500", bgColor: "bg-warning/5",
                    icon: FileCheck, iconColor: "text-warning dark:text-warning",
                  ...
                  },
                  {
                    ...
                    color: "bg-warning", borderColor: "border-t-orange-500", bgColor: "bg-warning/5",
                    icon: Users, iconColor: "text-warning dark:text-warning",
                  ...
                  },
                  {
                    ...
                    color: "bg-primary", borderColor: "border-t-indigo-500", bgColor: "bg-primary/5",
                    icon: ShieldCheck, iconColor: "text-primary dark:text-primary",
            ...
            <div className="space-y-3">
              ...
              <div className={`grid ${isMobile ? "grid-cols-1" : "grid-cols-2"} gap-3`}>
                <div className="rounded-xl border border-status-closed/30 bg-status-closed/5 p-4 space-y-2">
                  <div className="flex items-center gap-2">
                    <div className="h-8 w-8 rounded-lg bg-status-closed/15 flex items-center justify-center">
                      <Building2 className="h-4 w-4 text-status-closed dark:text-status-closed" />
                    </div>
                  ...
                  <ul className="space-y-1">
                    {(lang === "en"
                      ...
                      <li key={i} className="text-sm text-muted-foreground flex items-start gap-2">
                        <span className="text-status-closed mt-0.5">✓</span> {b}
                      </li>
                    ))}
                  </ul>
                </div>
            ...
            <div className={`grid ${isMobile ? "grid-cols-1" : "grid-cols-3"} gap-3`}>
              {[
                {
                  icon: Share2, iconColor: "text-primary dark:text-primary", bgColor: "bg-primary/10",
                ...
                {
                  icon: Fingerprint, iconColor: "text-accent dark:text-accent", bgColor: "bg-accent/10",
                ...
                {
                  icon: Bot, iconColor: "text-primary dark:text-primary", bgColor: "bg-primary/10",
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1.5">
              {[
                ...
                { level: 1, no: "Planlagt", en: "Planned", color: "bg-warning/20 dark:bg-warning", textColor: "text-warning dark:text-warning", barColor: "bg-warning", desc_no: "Kravet er forstått og eier er utpekt", desc_en: "Requirement understood, owner assigned" },
                { level: 2, no: "Dokumentert", en: "Documented", color: "bg-warning", textColor: "text-white", barColor: "bg-warning", desc_no: "Policy eller prosedyre finnes", desc_en: "Policy or procedure exists" },
                { level: 3, no: "Implementert", en: "Implemented", color: "bg-primary", textColor: "text-white", barColor: "bg-primary", desc_no: "Gjennomføres i praksis, ikke bare på papir", desc_en: "Carried out in practice, not just on paper" },
                { level: 4, no: "Verifisert", en: "Verified", color: "bg-status-closed", textColor: "text-white", barColor: "bg-status-closed", desc_no: "Evidens finnes og er nylig oppdatert", desc_en: "Evidence exists and is recently updated" },
              ].map((item) => (
            ...
            <CardContent className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div className="flex flex-col items-center gap-2 rounded-xl border border-border/50 bg-background/50 p-4">
                  <div className="h-14 w-14 rounded-full border-4 border-status-closed/30 flex items-center justify-center bg-status-closed/10">
                    <span className="text-base font-bold text-status-closed dark:text-status-closed">{progressPercent}%</span>
                  </div>
                ...
                {/* Coverage */}
                <div className="flex flex-col items-center gap-2 rounded-xl border border-border/50 bg-background/50 p-4">
                  <div className="h-14 w-14 rounded-full border-4 border-primary/30 flex items-center justify-center bg-primary/10">
                    <span className="text-base font-bold text-primary dark:text-primary">{Math.round((stats.total > 0 ? ((stats.completed + stats.inProgress) / stats.total) : 0) * 100)}%</span>
                  </div>
                  <div className="text-center">
                ...
                {/* Risk Exposure */}
                <div className="flex flex-col items-center gap-2 rounded-xl border border-border/50 bg-background/50 p-4">
                  <div className="h-14 w-14 rounded-full border-4 border-warning/30 flex items-center justify-center bg-warning/10">
                    <span className="text-xs font-bold text-warning dark:text-warning">{t("Middels", "Medium")}</span>
                  </div>
                  <div className="text-center">
          ...
          <div className="space-y-4">
            ...
            <Accordion type="multiple" className="space-y-2">
              ...
              <AccordionItem value="foundation" className="rounded-xl border border-border/50 bg-card px-4">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center gap-3">
                    <Layers className="h-4 w-4 text-status-closed flex-shrink-0" />
                    <span className="text-base font-semibold text-left">
                  ...
                  <div className="space-y-3 pb-2">
                    ...
                    <div className={`grid ${isMobile ? "grid-cols-1" : "grid-cols-2"} gap-2`}>
                      {[
                         ...
                         { no: "Drift og sikkerhet", en: "Drift og sikkerhet", desc_no: "Systemoversikt, backup, hendelseshåndtering, endringshåndtering", desc_en: "System inventory, backup, incident management, change management" },
                         ...
                         { no: "Tredjepart og verdikjede", en: "Third-Party & Supply Chain", desc_no: "Leverandøroversikt, DPA, leverandørrisikovurdering, underleverandørkontroll", desc_en: "Vendor inventory, DPA, vendor risk assessment, subprocessor oversight" },
                      ].map((d) => (
                ...
                <AccordionContent>
                  <div className="space-y-3 pb-2">
                    ...
                    {[
                      ...
                      { title_no: "Per fokusområde", title_en: "Per focus area", desc_no: "Styring, Drift og sikkerhet, Personvern og datahåndtering, Tredjepart og verdikjede.", desc_en: "Governance, Drift og sikkerhet, Privacy & Data Handling, Third-Party & Supply Chain." },
