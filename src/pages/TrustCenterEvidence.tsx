...
const seedDemoEvidence = async (assetId: string) => {
  ...
  const demoRows = [
    // Policies
    { asset_id: assetId, document_type: "privacy_policy", file_name: "personvernpolicy-2024.pdf", display_name: "Personvernpolicy", status: "verified", visibility: "published", category: "policy", created_at: new Date(now.getTime() - 90 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "security_policy", file_name: "infosec-policy-v3.pdf", display_name: "Informasjonssikkerhetspolicy", status: "verified", visibility: "published", category: "policy", created_at: new Date(now.getTime() - 120 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "acceptable_use", file_name: "akseptabel-bruk.pdf", display_name: "Akseptabel bruk-policy", status: "verified", visibility: "published", category: "policy", created_at: new Date(now.getTime() - 60 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "incident_response", file_name: "hendelsesplan-v2.pdf", display_name: "Hendelseshåndteringsplan", status: "draft", visibility: "hidden", category: "policy", created_at: new Date(now.getTime() - 14 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "data_protection_policy", file_name: "databeskyttelse-policy.pdf", display_name: "Databeskyttelsespolicy", status: "verified", visibility: "published", category: "policy", created_at: new Date(now.getTime() - 200 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "policy", file_name: "generell-it-policy.pdf", display_name: "Generell IT-policy", status: "pending", visibility: "published", category: "policy", created_at: new Date(now.getTime() - 7 * 86400000).toISOString() },
    // Certifications
    { asset_id: assetId, document_type: "certification", file_name: "iso27001-sertifikat.pdf", display_name: "ISO 27001:2022", status: "verified", visibility: "published", category: "certification", expiry_date: new Date(now.getTime() + 300 * 86400000).toISOString().split("T")[0], created_at: new Date(now.getTime() - 180 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "certification", file_name: "soc2-type2-report.pdf", display_name: "SOC 2 Type II", status: "verified", visibility: "published", category: "certification", expiry_date: new Date(now.getTime() + 180 * 86400000).toISOString().split("T")[0], created_at: new Date(now.getTime() - 150 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "certification", file_name: "cyber-essentials-plus.pdf", display_name: "Cyber Essentials Plus", status: "expiring", visibility: "published", category: "certification", expiry_date: new Date(now.getTime() + 20 * 86400000).toISOString().split("T")[0], created_at: new Date(now.getTime() - 340 * 86400000).toISOString() },
    // Documents
    { asset_id: assetId, document_type: "agreement", file_name: "databehandleravtale-2024.pdf", display_name: "Databehandleravtale", status: "verified", visibility: "published", category: "document", created_at: new Date(now.getTime() - 45 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "report", file_name: "risikovurdering-q1.pdf", display_name: "Risikovurderingsrapport Q1 2025", status: "verified", visibility: "hidden", category: "document", created_at: new Date(now.getTime() - 30 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "evidence", file_name: "pentest-rapport-2025.pdf", display_name: "Penetrasjonstestrapport", status: "pending", visibility: "hidden", category: "document", created_at: new Date(now.getTime() - 10 * 86400000).toISOString() },
    { asset_id: assetId, document_type: "other", file_name: "beredskapsplan.pdf", display_name: "Beredskapsplan", status: "draft", visibility: "hidden", category: "document", created_at: new Date(now.getTime() - 5 * 86400000).toISOString() },
  ];
